...
// Final Project // Alegar - Cañete - Misenas - Novero - Sollestre
...
//  Last Update 2:35PM   5-14-23 - EVERYONE - Fixes to all functions.
...
case 'i': case 'I': // Array Insertion Operation
    ...
    case 'd': case 'D': // Array Deletion Operation
        ...
        int arr_index;
        cout << "Enter the index/value to delete: ";
        cin >> arr_index;
    ...
    case 'o': case 'O':
        ...
        quickSort(arr, 0, n - 1);
        cout << "Array is sorted in ascending order using Quick Sort technique." << endl;
        system("PAUSE");
        system("CLS");
        }
        break;
